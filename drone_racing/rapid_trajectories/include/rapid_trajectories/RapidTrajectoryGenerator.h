...
public:
  ...
  //RapidTrajectoryGenerator(const RapidTrajectoryGenerator& old);
  ...
  double GetEndTime() const {return _tf;};
  Vec3 GetPositionAtEnd() const     {return Vec3(_axis[0].GetPosition(_tf), _axis[1].GetPosition(_tf), _axis[2].GetPosition(_tf));};
  Vec3 GetVelocityAtEnd() const     {return Vec3(_axis[0].GetVelocity(_tf), _axis[1].GetVelocity(_tf), _axis[2].GetVelocity(_tf));};
